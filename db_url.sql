...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-08-2020 a las 03:34:05
...
--
-- Base de datos: `db_url`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `slug`
--
...
--
-- AUTO_INCREMENT de la tabla `slug`
--
ALTER TABLE `slug`
